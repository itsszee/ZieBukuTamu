...
if(isset($_POST['login'])) {
    ...
    $error = true; // Mengubah nama variabel dari erorr ke error
}
?>
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                <img class="img-fluid mx-auto w-100 p-1 h-100" src="assets/img/undraw_posting_photo.svg" alt="image">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
